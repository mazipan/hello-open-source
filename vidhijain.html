...
<body>  
    ...
    <input type="radio" id="happy" name="status">Be Happy with what you have<br> <!-- "br" tag corrected -->
    <input type="radio" id="excited" name="status">Be Excited about what you want<br> <!-- "br" tag corrected -->
    <input type="radio" id="sad" name="status">Don't be Sad <br> <!-- "br" tag corrected -->
        ...
        document.body.addEventListener('change', function (e) {  
            ...
            switch (target.id) {  
                ...
                case 'angry':  
                    ...
                    break;  
                case 'none':  
                    display_msg = 'That\'s great'; // Corrected text for 'none'
                    break;  
            }  
